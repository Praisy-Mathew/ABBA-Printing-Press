...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative p-0">
            ...
            <!-- Header Start -->
            <div class="container-fluid bg-breadcrumb" style="background-image: url('img/carousel-1.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; height: 550px;" >
                <div class="container text-center py-5" style="max-width: 900px;">
                    <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s" style="font-size:25px; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;color: white; font-style: italic;" >Contact Us</h4>
                                    ...
                                    <div class="contact-add-item">
                                        ...
                                        <div>
                                            ...
                                            <p class="mb-0">Telephone: +971 6 535 0351<br>
                                               <span style="margin-left: 0px;"> Mobile: +971 50 631 8150</span><br>
...
<div class="col-xl-6 wow fadeInRight" data-wow-delay="0.2s">
    <div class="bg-light p-5 rounded h-100 wow fadeInUp" data-wow-delay="0.2s">
        <h4 class="text-primary text-center">Send Your Message</h4>
        <form action="{{ route('contact.store') }}" method="POST">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-12 col-xl-6">
                    <div class="form-floating">
                        <input type="text" class="form-control border-0" id="phone" name="phone" placeholder="Phone" required>
