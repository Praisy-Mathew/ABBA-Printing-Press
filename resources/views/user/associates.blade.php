...
<html lang="en">
    ...
    <body>
        ...
        <div class="container-fluid position-relative p-0">
            <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <a href="associates" class="nav-item nav-link active">Our Network</a>
                    </div>
         ...
         <div class="container-fluid bg-breadcrumb" style="background-image: url('img/nets.jpg'); background-size: cover; background-position: center; background-repeat: no-repeat; height: 450px;" >  
            <div class="container text-center py-5" style="max-width: 900px;">
                 <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.1s" style="font-size:30px;; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif;color: white; font-style: italic; "></h4>
                </h4>
        ...
        <div class="container-fluid service overflow-hidden py-3">
            <div class="container py-3">
                <div class="section-title text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="sub-style" style="margin-top: 50px;">
                        <h5 class="sub-title text-primary px-3">Our Network</h5>
                    </div>
                    <h1 class="display-5 mb-4">Part of Our Network</h1>
                    <p class="mb-0">At ABBA, our network of businesses works seamlessly together to provide top-tier services in printing, events and exhibition, and manufacturing. Whether you need high-quality prints, exceptional event planning, or cutting-edge design solutions, ABBA's integrated approach ensures that every project benefits from our collective expertise.
        ...
        <!-- <div class="container">
            <div class="row" style="margin-top: 1px;">
                <div class="col-12" style="margin-bottom: 40px;">
                    <img src="img/abba-logo3...png" alt="Image 1" style="width: 85%; height:120px; align-items: center;">
                </div>
                <div class="col-12" style="margin-bottom: 40px;">
                    <img src="img/abba-logo1...png" alt="Image 2" style="width: 85%; height: 120px;;">
                </div>
                <div class="col-12" style="margin-bottom: 40px;">
                    <img src="img/abba-logo2...png" alt="Image 3" style="width: 85%; height:120px;">
                </div>
            </div>
        </div> -->
         <div class="container">
            <div class="row" style="margin-top: 1px;">
                <div class="col-12" style="margin-bottom: 40px;">
                    <img src="img/ab333.png" alt="Image 1" class="img-fluid" style="max-width: 90%; height: auto;">
                </div>
                <div class="col-12" style="margin-bottom: 40px;">
                    <img src="img/ab111.png" alt="Image 2" class="img-fluid" style="max-width: 90%; height: auto;">
                </div>
                <div class="col-12" style="margin-bottom: 40px;">
                    <img src="img/ab222.png" alt="Image 3" class="img-fluid" style="max-width: 90%; height: auto;">
                </div>
            </div>
        </div> 
